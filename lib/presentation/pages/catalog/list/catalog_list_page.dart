...
import 'package:next_starter/presentation/pages/catalog/list/cubit/catalog_list_cubit.dart';
...
class _CatalogListPageState extends State<CatalogListPage> {
  final bloc = locator<CatalogListCubit>();
    ...
    return MultiBlocProvider(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          elevation: 0,
          title: const Text('Recording Task'),
          actions: [
            IconButton(
              onPressed: () async {
          ...
          builder: (context, form, child) {
            return Column(
              children: [
                ...
                BlocBuilder<CatalogListCubit, CatalogListState>(
